...
import (
	...
	"github.com/devNica/mochileros/middlewares"
...
func (controller hotelController) Route(app *fiber.App) {
	app.Post("/mochileros/v1/owner/hotel", middlewares.AuthenticateJWT("owners"), controller.RegisterHotel)
	app.Get("/mochileros/v1/owner/:ownerId/hotel", middlewares.AuthenticateJWT("owners"), controller.ListOwnerHotels)
}
